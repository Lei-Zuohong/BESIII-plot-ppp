...
option2 = 'gamma1_heli'
option3 = 'gamma2_heli'
option4 = 'picture/2_topology/6.topo_helicity_fom'
...
def plot(energy=0,
    ...
    # 统计序列
    x, fom, efom = default.fom_pm([thist['08']],
    ...
    # 2.get tgraph
    error_ratio = ROOT.TGraphErrors(inter / 2)
    ...
    error_ratio.GetXaxis().SetRangeUser(0, 1)
