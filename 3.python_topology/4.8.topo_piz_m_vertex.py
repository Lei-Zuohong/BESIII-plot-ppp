...
option2 = 'piz_m'
option4 = 'picture/2_topology/7.topo_piz_m'
...
def plot(energy=0,
    ...
    drawlist = hstyle.add_arrow(drawlist,
                                selecters['piz_m'].center - 0.015, 0,
                                selecters['piz_m'].center - 0.015, 0.5 * thist['real'].GetMaximum(),
    ...
    drawlist = hstyle.add_arrow(drawlist,
                                ...
                                Linecolor=2, Linewidth=3)
    drawlist = hstyle.add_arrow(drawlist,
                                selecters['piz_m'].center - 0.060, 0,
                                selecters['piz_m'].center - 0.060, 0.5 * thist['real'].GetMaximum(),
                                Linecolor=3, Linewidth=3)
    drawlist = hstyle.add_arrow(drawlist,
                                selecters['piz_m'].center - 0.030, 0,
                                selecters['piz_m'].center - 0.030, 0.5 * thist['real'].GetMaximum(),
                                Linecolor=3, Linewidth=3)
    drawlist = hstyle.add_arrow(drawlist,
                                selecters['piz_m'].center + 0.030, 0,
                                selecters['piz_m'].center + 0.030, 0.5 * thist['real'].GetMaximum(),
