...
energy = 2.1250
tree = 'fit4c'
pictures = ['opicture/analysis/dalitz_phok.pdf',
            'opicture/analysis/dalitz_phok.jpg']
stop = 'yes'
...
selecters['flag2'].values = [8]
selecters['flag3'].values = [4]
# 初始化数据
...
alldata.trees['back_back']['dalitz_pm'] = alldata.trees['back_back']['pipm_m']**2
alldata.trees['back_back']['dalitz_pz'] = alldata.trees['back_back']['pipz_m']**2
namef['r'], nameh['r'] = alldata.hist(data='back_back',
