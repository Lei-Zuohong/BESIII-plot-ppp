...
def weight(energy):
    ...
    weighter.set_branch(['pipm_m', 'pipz_m'])
    weighter.set_data_m(data=[tree_m['pipm_m'], tree_m['pipz_m']])
    weighter.set_data_r(data=[tree_r['pipm_m'], tree_r['pipz_m']])
    weighter.set_data_b(data1=[tree_b1['pipm_m'], tree_b1['pipz_m']],
                        data2=[tree_b2['pipm_m'], tree_b2['pipz_m']])
    weighter.set_bins()
    weighter.set_matrix()
    weighter.set_weight()
    weighter.clean()
