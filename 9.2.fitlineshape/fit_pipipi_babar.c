...
int fit_pipipi_babar()
{
    usedata = bes_data::pipipi_babar;
    usedata.cut(1.1, 3.1);
...
#pragma region 3.1.fit
    ...
    my_fit->mnparm(7, "back                 ", 2.83825e+01, 0.0010, 0.0000, 10000, fit_error);
    my_fit->mnparm(8, "phase_back           ", -2.3177e+00, 0.0010, -7.000, 7.000, fit_error);
    fit_index[0] = 1000;
    fit_index[1] = 0.001;
...
#pragma region 3.3.draw
    ...
    {
        TF1 *func_best = new TF1("func_best", Func_pipipi, 1.1, 3.1, 10);
        double func_best_start[9] = {bestPar[0], bestPar[1], bestPar[2], bestPar[3], bestPar[4],
                                     bestPar[5], bestPar[6], bestPar[7], bestPar[8]};
    ...
    legend->Draw();
    c1->Update();
    c1->Print("fit_pipipi_babar.pdf");
    c1->Print("fit_pipipi_babar.jpg");
#pragma endregion
