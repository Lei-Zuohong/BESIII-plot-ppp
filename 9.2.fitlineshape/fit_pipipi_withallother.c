...
int fit_pipipi_withallother()
{
    bes_data::pipipi_beslow.cut(1.1, 2.0);
    bes_data::pipipi_snd.cut(1.1, 2.0);
    bes_data::pipipi_babar.cut(1.1, 2.0);
    usedata = bes_data::add_DATA(bes_data::pipipi_bes, bes_data::pipipi_snd);
    usedata = bes_data::add_DATA(bes_data::pipipi_babar, usedata);
    usedata = bes_data::add_DATA(bes_data::pipipi_beslow, usedata);
...
#pragma region 3.1.fit
    ...
    my_fit->mnparm(7, "mr_omega_new         ", 2.20000, 0.0010, 2.0000, 2.400, fit_error);
    my_fit->mnparm(8, "wr_omega_new         ", 0.10000, 0.0010, 0.0100, 1.000, fit_error);
    my_fit->mnparm(9, "b1b2_omega_new       ", 1.50000, 0.0100, 0.0000, 100.0, fit_error);
    my_fit->mnparm(10, "phase_omega_new      ", 1.57000, 0.0010, -7.000, 7.000, fit_error);
...
#pragma region 3.3.draw
    ...
    legend->Draw();
    c1->Update();
    c1->Print("fit_pipipi_withallother.pdf");
    c1->Print("fit_pipipi_withallother.jpg");
#pragma endregion
