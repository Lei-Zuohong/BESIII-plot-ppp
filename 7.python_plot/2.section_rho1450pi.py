...
#filename['factor'] = '%s.pkl' % (massages['factor_rho1450pi'])
filename['factor'] = 'fdata/1.factor_rho1450pi-00-02.pkl'
filename['event'] = 'fdata/3.nevent_rho1450pi.pkl'
data = {}
for i in filename:
...
for energy in energy_sort:
    ...
    # 录入误差
    error = {}
    error['pwa'] = hfile.pkl_read('fdata_error/pwa_total/rho1450pi/%1.4f.pkl' % (energy))
...
fileoutput = '%s.pkl' % (massages['section_rho1450pi'])
