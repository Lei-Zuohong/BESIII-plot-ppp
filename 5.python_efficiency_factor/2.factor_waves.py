...
print(massage['version']),
print(1),
filelog = '/besfs5/groups/tauqcd/leizh/ppp/mc/sim/pppmpz-%s' % (massage['version'])
filepickle = '%s.pkl' % (massage['factor'])
filepickle_rho770pi = '%s.pkl' % (massage['factor_rho770pi'])
filepickle_rho1450pi = '%s.pkl' % (massage['factor_rho1450pi'])
filepickle_omega782pi = '%s.pkl' % (massage['factor_omega782pi'])
######################################################
factor = {}
hprint.pstar()
...
hfile.pkl_dump(filepickle_rho770pi, factor)
hfile.pkl_dump(filepickle_rho1450pi, factor)
hfile.pkl_dump(filepickle_omega782pi, factor)
