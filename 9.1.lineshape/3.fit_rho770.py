...
p.add(name='wr', value=0.07, min=0.01, max=0.3)
p.add(name='b', value=5.0, min=0.01, max=100.0)
p.add(name='phase', value=0.0, min=-20.0, max=20.0)
p.add(name='mr_c', value=1.5, min=0.0, max=1.6)
p.add(name='wr_c', value=1.0, min=0.01, max=10.0)
p.add(name='b_c', value=500.0, min=0.01, max=100000.0)
p.add(name='phase_c', value=0.0, min=-20.0, max=20.0)
p.add(name='p0', value=100.0, min=-1000.0, max=1000.0)
