...
int fit_rhopi_besiii()
{
    usedata = bes_data::rhopi_bes;
...
#pragma region 3.1.fit
    ...
    // 设定初始值、边界、步长
    my_fit->mnparm(0, "b1b2_phi             ", 2.10160e+03, 1.0000, 0.0000, 10000, fit_error);
    ...
    my_fit->mnparm(12, "phase_back           ", -2.3177e+00, 0.0010, -7.000, 7.000, fit_error);
    fit_index[0] = 1000;
    fit_index[1] = 0.001;
...
#pragma region 3.3.draw
    ...
    if (option_draw_origin == 1)
    {
        ...
        NameAxes(Ddata, "#sqrt{s} (GeV)", "#sigma(e^{+}e^{-} #rightarrow #rho#pi) (pb)");
    ...
    legend->Draw();
    c1->Update();
    c1->Print("fit_rhopi_besiii.pdf");
    c1->Print("fit_rhopi_besiii.jpg");
#pragma endregion
